...
{
    public partial class frmPrintInbound : Form
    {
        ...
        private string __AUTHCODE__ = CheckAuth.ValidCheck(CommonValues.packageNo, 32, 0);   // 패키지번호, 프로그램번호, 윈도우번호

        public frmPrintInbound()
        {
            InitializeComponent();
        }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    rptInbound report = new rptInbound();
        ...
        private void DataBinding_Order()
        {
            try
            {
                ...
                dsData = Data.InboundData.GetlistReport(_searchString, _searchKey, "2000-01-01");
            }
            catch (Exception ex)
            {
