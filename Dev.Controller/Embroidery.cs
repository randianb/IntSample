...
namespace Dev.Controller
{
    public class Embroidery
    {
        ...
        {
            DataRow row = Data.EmbroideryData.Insert(OrderIdx, CuttedIdx, WorkOrderIdx, OutOrderIdx, OrdColorIdx, OrdSizeIdx, OrdQty,
                                    ...
                                    Dictionary<CommonValues.KeyName, string> SearchString)
        {
            ...
            ds = Data.EmbroideryData.Getlist(SearchKey, SearchString); 
        ...
        {
            bool blRtn;
            blRtn = Data.EmbroideryData.Update(_idx, _outOrderIdx, _rcvdDate, _rcvdQty, _rcvdFrom, 
                                            _remarks);
            return blRtn;
        }
        ...
        {
            bool blRtn;
            blRtn = Data.EmbroideryData.Delete(condition);
            return blRtn;
        }
