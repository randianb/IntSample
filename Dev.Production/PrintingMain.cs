...
namespace Dev.Production
{
    ...
    /// 나염 외주오더현황 
    /// </summary>
    public partial class PrintingMain : InheritForm
    {
        #region 1. 변수 설정
        ...
        private Controller.Printing _obj1 = null;                                // 현재 생성된 객체 
        ...
        private string _layoutfile = "/GVLayoutPrinting.xml";
        ...
        public PrintingMain(InheritMDI main, string WorkOrderIdx)
        {
                                    ...
                                    Dictionary<CommonValues.KeyName, string> SearchString)
        {
            try
            {
                ...
                _ds1 = Controller.Printing.Getlist(SearchKey, SearchString);
                if (_ds1 != null)
                {
        ...
        private void GV1_Update(object sender, GridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                // 객체생성 및 값 할당
                _obj1 = new Controller.Printing(Convert.ToInt32(_gv1.Rows[row.Index].Cells["Idx"].Value));
                ...
                _bRtn = _obj1.Update();
                __main__.lblRows.Text = "Updated Printing Info";
