...
{
    public partial class PrintCutting : Form
    {
        ...
        private string __AUTHCODE__ = CheckAuth.ValidCheck(CommonValues.packageNo, 82, 0);   // 패키지번호, 프로그램번호, 윈도우번호
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    rptPrintCutting report = new rptPrintCutting();
        ...
        private void DataBinding_Order()
        {
            try
            {
                ...
                dsData = Dev.Controller.Cutting.Getlist(_searchKey, _searchString); //, dtFromDate.Value, dtToDate.Value);
            }
            catch (Exception ex)
            {
