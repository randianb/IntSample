...
{
    public partial class PrintSewing : Form
    {
        ...
        private string __AUTHCODE__ = CheckAuth.ValidCheck(CommonValues.packageNo, 91, 0);   // 패키지번호, 프로그램번호, 윈도우번호
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    rptPrintSewing report = new rptPrintSewing();
        ...
        private void DataBinding_Order()
        {
            try
            {
                ...
                dsData = Dev.Controller.Sewing.Getlist(_searchKey, _searchString); //, dtFromDate.Value, dtToDate.Value);
            }
            catch (Exception ex)
            {
