...
{
    public partial class PrintInspection : Form
    {
        ...
        private string __AUTHCODE__ = CheckAuth.ValidCheck(CommonValues.packageNo, 92, 0);   // 패키지번호, 프로그램번호, 윈도우번호
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    rptPrintInspection report = new rptPrintInspection();
        ...
        private void DataBinding_Order()
        {
            try
            {
                ...
                dsData = Dev.Controller.Inspecting.Getlist(_searchKey, _searchString); //, dtFromDate.Value, dtToDate.Value);
            }
            catch (Exception ex)
            {
