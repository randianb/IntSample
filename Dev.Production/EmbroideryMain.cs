...
namespace Dev.Production
{
    ...
    /// 자수 외주오더현황 
    /// </summary>
    public partial class EmbroideryMain : InheritForm
    {
        #region 1. 변수 설정
        ...
        private Controller.Embroidery _obj1 = null;                                // 현재 생성된 객체 
        ...
        private string _layoutfile = "/GVLayoutEmbroidery.xml";
        ...
        private string __AUTHCODE__ = CheckAuth.ValidCheck(CommonValues.packageNo, 41, 0);   // 패키지번호, 프로그램번호, 윈도우번호
        ...
        public EmbroideryMain(InheritMDI main, string WorkOrderIdx)
        {
        ...
        private void GV1_CreateColumn(RadGridView gv)
        {
            ...
            GridViewTextBoxColumn RcvdQty = new GridViewTextBoxColumn();
            RcvdQty.Name = "RcvdQty";
            RcvdQty.FieldName = "RcvdQty";
            RcvdQty.HeaderText = "Rcvd Q'ty";
            RcvdQty.Width = 70;
            RcvdQty.TextAlignment = System.Drawing.ContentAlignment.MiddleRight;
            gv.Columns.Add(RcvdQty);
            ...
            Balance.Expression = "RcvdQty-OrdQty"; 
                                    ...
                                    Dictionary<CommonValues.KeyName, string> SearchString)
        {
            try
            {
                ...
                _ds1 = Controller.Embroidery.Getlist(SearchKey, SearchString);
                if (_ds1 != null)
                {
        ...
        private void GV1_Update(object sender, GridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                // 객체생성 및 값 할당
                _obj1 = new Controller.Embroidery(Convert.ToInt32(_gv1.Rows[row.Index].Cells["Idx"].Value));
                ...
                _bRtn = _obj1.Update();
                __main__.lblRows.Text = "Updated Embroidery Info";
            ...
            try
            {
                if (e.Column.Name == "complete")
                {
                    ...
                    else
                    {
                        ...
                        {
                            _bRtn = Data.EmbroideryData.CompleteWork(
        ...
        private void radMenuItem1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    // 워크시트 열기 
                    DirectWorkOrder frm = new DirectWorkOrder(Int.Members.GetCurrentRow(_gv1, "Idx"), 113);     // embroidery order 
                    frm.Text = "Work Order";
