...
{
    public partial class PrintEmbroidery : Form
    {
        ...
        private string __AUTHCODE__ = CheckAuth.ValidCheck(CommonValues.packageNo, 90, 0);   // 패키지번호, 프로그램번호, 윈도우번호

        public PrintEmbroidery()
        {
            InitializeComponent();
        }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    rptPrintEmbroidery report = new rptPrintEmbroidery();
        ...
        private void DataBinding_Order()
        {
            try
            {
                ...
                dsData = Dev.Controller.Embroidery.Getlist(_searchKey, _searchString); //, dtFromDate.Value, dtToDate.Value);
            }
            catch (Exception ex)
            {
