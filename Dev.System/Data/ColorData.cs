    ...
    public class ColorData
    {
        ...
        public static DataRow Insert(string ColorName, int Classification, int IsUse)
        {
            try
            {
                ...
                _cmd.CommandText = "up_Colors_Insert";
                _cmd.CommandType = CommandType.StoredProcedure;
                _cmd.Connection = _conn;

                _cmd.Parameters.Add("@ColorName", SqlDbType.NVarChar, 30);
                _cmd.Parameters["@ColorName"].Value = ColorName;
        ...
        /// Update
        /// </summary>
        public static bool Update(int ColorIdx, string ColorName, int Classification, int IsUse)
        {
            try
            {
                _cmd = new SqlCommand();
                ...
                _cmd.CommandText = "up_Colors_Update";
                _cmd.CommandType = CommandType.StoredProcedure;
                _cmd.Connection = _conn;
        ...
        /// Get: 해당 ID조회 
        /// </summary>
        public static DataRow Get(int ColorIdx)
        {
            try
            {
                _conn = new SqlConnection(_strConn);
                ...
                _cmd.CommandText = "up_Colors_Get";
                _cmd.CommandType = CommandType.StoredProcedure;
                _cmd.Connection = _conn;
        ...
        public static DataSet Getlist()
        {
            try
            {
                ...
                _cmd.CommandText = "up_Colors_List";
                _cmd.CommandType = CommandType.StoredProcedure;
                _cmd.Connection = _conn;
        ...
        public static DataSet GetUselist()
        {
            try
            {
                ...
                _cmd.CommandText = "up_Colors_List3";
                _cmd.CommandType = CommandType.StoredProcedure;
                _cmd.Connection = _conn;
        ...
        public static DataSet Getlist(string ColorName)
        {
            try
            {
                ...
                _cmd.CommandText = "up_Colors_List2";
                _cmd.CommandType = CommandType.StoredProcedure;
                _cmd.Connection = _conn;

                _cmd.Parameters.Add("@ColorName", SqlDbType.NVarChar, 40);
                _cmd.Parameters["@ColorName"].Value = ColorName;
        ...
        /// Delete
        /// </summary>
        public static bool Delete(int ColorIdx)
        {
            try
            {
                _cmd = new SqlCommand();
                ...
                _cmd.CommandText = "up_Colors_Delete";
                _cmd.CommandType = CommandType.StoredProcedure;
                _cmd.Connection = _conn;
        ...
        public static bool Delete(string condition)
        {
            try
            {
                ...
                _cmd.CommandText = "up_Colors_Delete2";
                _cmd.CommandType = CommandType.StoredProcedure;
                _cmd.Connection = _conn;
