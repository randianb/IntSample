    ...
    public class EmbroideryData
    {
            ...
            )
        {
            try
            {
                ...
                _cmd.CommandText = "up_Embroidery_Insert";
            ...
            )
        {
            try
            {
                ...
                _cmd.CommandText = "up_Embroidery_Update";
                _cmd.CommandType = CommandType.StoredProcedure;
                _cmd.Connection = _conn;
        ...
        public static DataRow Get(int Idx)
        {
            try
            {
                ...
                _cmd.CommandText = "up_Embroidery_Get";
                _cmd.CommandType = CommandType.StoredProcedure;
                _cmd.Connection = _conn;
                                      ...
                                      Dictionary<CommonValues.KeyName, string> SearchString)
        {
            try
            {
                ...
                _cmd.CommandText = "up_Embroidery_List2";
                _cmd.CommandType = CommandType.StoredProcedure;
                _cmd.Connection = _conn;
        ...
        public static bool Delete(string condition)
        {
            try
            {
                ...
                _cmd.CommandText = "up_Embroidery_Delete2";
                _cmd.CommandType = CommandType.StoredProcedure;
                _cmd.Connection = _conn;
