    ...
    public class OrderFabricData
    {
        ...
        public static DataRow Insert(int OrderIdx)
        {
            try
            {
                ...
                _cmd.CommandText = "up_OrderFabric_Insert";
            ...
            )
        {
            try
            {
                ...
                _cmd.CommandText = "up_OrderFabric_Update";
                _cmd.CommandType = CommandType.StoredProcedure;
                _cmd.Connection = _conn;
                ...
                _cmd.Parameters.Add("@Remark", SqlDbType.NVarChar, 70);
        ...
        public static DataRow Get(int Idx)
        {
            try
            {
                ...
                _cmd.CommandText = "up_OrderFabric_Get";
                _cmd.CommandType = CommandType.StoredProcedure;
                _cmd.Connection = _conn;
        ...
        public static DataSet Getlist(int OrderIdx)
        {
            try
            {
                ...
                _cmd.CommandText = "up_OrderFabric_List";
                _cmd.CommandType = CommandType.StoredProcedure;
                _cmd.Connection = _conn;
        ...
        public static bool Delete(string DeleteIdx)
        {
            try
            {
                ...
                _cmd.CommandText = "up_OrderFabric_Delete2";
                _cmd.CommandType = CommandType.StoredProcedure;
                _cmd.Connection = _conn;
